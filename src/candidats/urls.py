...
urlpatterns = [
    ...
    path('entretiens_backoffice/<int:entretien_id>/annuler/', views.backoffice_entretien_quick_action, {'action': 'annuler'}, name='backoffice_entretien_annuler'),
    path('entretiens_backoffice/<int:entretien_id>/terminer/', views.backoffice_entretien_quick_action, {'action': 'terminer'}, name='backoffice_entretien_terminer'),
